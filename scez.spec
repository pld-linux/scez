...
SCEZ to biblioteka ułatwiająca tworzenie przenośnego oprogramowanie
używającego kart procesorowych.

Obsługiwane czytniki:
- ACS ACR20S/Cybermouse (na tyle, na ile da się obsłużyć te ułomne
  czytniki)
- Dumb Mouse
- Gemplus GCR410
- Intertex IX2
...
- Towitoki Chipdrive
- oraz dowolny czytnik obsługujący CT-API

Obsługiwane karty:
- ComCard MFC (w większości nie testowane)
- GeldKarte
